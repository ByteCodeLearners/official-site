...
<v-row justify="center">
  <v-btn outlined color="#fff" to="/"><v-icon>mdi-home</v-icon> Go back in initial page, is better.</v-btn>
</v-row>
  </div>
</template>

<script>
import navbar from "../components/Layout/ByteCodeNavigationDrawer.vue"
export default {
  components:{
    navbar,
  }
